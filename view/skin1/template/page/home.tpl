...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-primary">
            ...
            <a href="?route=addon/invoices/getList&statustime=upcoming">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="?route=addon/invoices/getList&statustime=deadline">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="?route=addon/invoices/getList&statustime=expired">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Cần thanh lý!</div>
                    </div>
                </div>
            </div>
            <a href="?route=addon/invoices/getList&statustime=liquidation">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
