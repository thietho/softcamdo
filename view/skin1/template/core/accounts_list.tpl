...
<script language="javascript">
    ...
    $('#btnCatEdit').click(function(e) {
        window.location = '?route=core/accounts/update&accountid='+ $(this).attr('catid');
    });
    $('#btnCatAddChild').click(function(e) {
        window.location = '?route=core/accounts/insert&parent='+ $(this).attr('catid');
    });
    ...
    function deleteitem(catid)
    {
        ...
        if (answer)
        {
            $.get("?route=core/accounts/delete&catid="+catid,
    ...
    function updateTree()
    {
        ...
        $.post("?route=core/accounts/updateTree",
