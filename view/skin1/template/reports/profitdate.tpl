<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <form name="frm" id="frmProfit" action="<?php echo @$action?>" method="post" enctype="multipart/form-data">
...
$('#btnShowReport').click(function () {
    $.post("?route=reports/profitdate/showReport",$('#frmProfit').serialize(), function (html) {
