<form id="frmPayOff" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="form-group col-lg-6">
            ...
            <label>Số tiền đề xuất thanh lý</label>
            <?php echo $this->string->numberFormate($item['amount']*$item['rate']/100/30*$numdate + $item['amount']) ?>
        </div>
